...
export const BackgroundBlobsLight = () => {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none bg-white">
      {/* Blob muy grande */}
      <motion.div
        className="absolute w-[1000px] h-[1000px] bg-stone-300 rounded-full blur-3xl opacity-40"
      ...
      {/* Blob mediano */}
      <motion.div
        className="absolute w-[800px] h-[800px] bg-blue-200 rounded-full blur-3xl opacity-40"
        initial={{ x: 0, y: 0, scale: 1 }}
        animate={blob2}
      ...
      {/* Blob pequeño */}
      <motion.div
        className="absolute w-[700px] h-[700px] bg-slate-300 rounded-full blur-3xl opacity-40"
        initial={{ x: 0, y: 0, scale: 1 }}
        animate={blob3}
