...
export const Welcome = () => {
    ...
    const handleStart = () => {
      ...
      }, 800); // tiempo del fade out antes de redirigir
    };
        ...
        {!fadeOut && (
          ...
          >
            ...
            <motion.p
              ...
              className="text-md tracking-widest text-white mb-10 font-sans mx-auto font-bold"
            >
             Diseñador Sr. Front End Developer Jr.
            </motion.p>
